        ...
        <div className="services">
            <div className="container-fluid col-10 col-md-9 col-xl-8 p-0 align-items-center my-6 text-center">
                ...
                <p className="service-parah mt-3 mb-5">
                    OnSprint Global works with the entire product support and
                    maintenance. As one of the pioneers and leaders in Sri Lanka's tech
                    industry, we have a strong brand name and attract the best local
                    talent.
                </p>
                <Row xl={3} md={2} sm={1} xs={1} className="g-4 align-items-center justify-content-center">
                    {services.map((data, index) => <Col key={index}>
