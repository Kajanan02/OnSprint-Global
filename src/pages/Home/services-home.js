            ...
            <Reveal effect="fadeInUp">
                <div className="container-fluid col-10 col-md-9 col-xl-8 p-0 align-items-center my-6 text-center">
                    ...
                    <p className="service-parah mt-3 mb-5">
                        At OnSprint Global, we take pride in offering an array of IT
                        services designed to help businesses thrive in the digital age. Our
                        commitment to excellence and innovation is at the core of everything
                        we do.
                    </p>
                    <Row
                        xl={3}
