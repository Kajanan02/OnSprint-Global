          ...
          <Col xl={7} md={7} sm={12}>
            <Form onSubmit={sendMsg}>
              <Form.Group className="mb-4 mt-2">
                ...
                <Form.Control type="text"  placeholder="Enter Name" value={formData.fullName} required name={"fullName"} onChange={handleChange}/>
              </Form.Group>
              <Form.Group className="mb-4">
                <Form.Label>Email</Form.Label>
                <Form.Control type="email" placeholder="Enter email" value={formData.email} required  name={"email"} onChange={handleChange}/>
              </Form.Group>
              <Form.Group className="mb-4">
